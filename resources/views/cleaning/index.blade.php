@extends('cleaning.layout.master')
...
@section('content')
        ...
        <div class="swiper h-100 magic-cursor swiper-light-pagination"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide cover-background"
                    style="background-image:url('{{ asset('assets/cleaning/images/demo-cleaning-slider-01.png') }}');">
                   
                </div>

                <div class="swiper-slide cover-background"
                    style="background-image:url('{{ asset('assets/cleaning/images/demo-cleaning-slider-02.png') }}');">
                    
                </div>

                <div class="swiper-slide cover-background"
                    style="background-image:url('{{ asset('assets/cleaning/images/demo-cleaning-slider-03.png') }}');">
        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10 md-mb-50px"
                    data-anime='{ "translate": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <figure class="position-relative mb-0 border-radius-6px overflow-hidden">
                            <img src={{ asset('assets/cleaning/images/demo-cleaning-about.png') }} class="w-100 border-radius-6px" alt="">
                ...
                <div class="col-xl-5 col-lg-6 col-md-10 offset-xl-1"
                    ...
                    <h2 class="fw-700 ls-minus-1px text-dark-gray mb-20px">The Best Cleaning Solutions for Your Home and Business.</h2>
                    <p class="w-90 lg-w-100">Our expert cleaning services cover everything from routine tasks to specialized cleaning, ensuring reliable and efficient solutions for all your needs. Whether it's your home or business, we deliver exceptional results every time.</p>
                                ...
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-01.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-01.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                        ...
                        <li class="grid-item transition-inner-all atropos atropos-rotate-touch" data-atropos=""
                            ...
                            <div class="atropos-scale">
                                <div class="atropos-rotate">
                                    <div class="atropos-inner" data-atropos-offset="3">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-02.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-02.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        ...
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-03.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-03.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-04.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-04.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-05.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-05.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-06.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-06.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-07.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-07.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
                            ...
                            <div class="atropos-scale"
                                ...
                                <div class="atropos-rotate"
                                    ...
                                    <div class="atropos-inner" data-atropos-offset="3"
                                        style="transition-duration: 300ms; transform: translate3d(0px, 0px, 0px);">
                                        <div class="gallery-box">
                                            <a href={{ asset('assets/cleaning/images/demo-cleaning-gallery-08.png') }}
                                                data-group="lightbox-group-gallery-item-2"
                                                title="Lightbox gallery image title">
                                                <div class="position-relative gallery-image bg-slate-blue">
                                                    <img src={{ asset('assets/cleaning/images/demo-cleaning-gallery-08.png') }} alt=""
                                                        data-no-retina="">
                                                    <div
                                                        class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                                                        <i class="bi bi-camera icon-medium text-white"></i>
            ...
            <div class="row justify-content-center mb-3 xs-mb-2">
                <div class="col-lg-7 text-center"
                    ...
                    <span
                        ...
                        services</span>
                    <h2 class="text-dark-gray fw-700 mb-0 ls-minus-1px">cleaning services</h2>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div class="#services">
                                                <a href="demo-logistics-our-services.html"
                                                    class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Residential Cleaning</a>
                                                <p class="mb-15px">Keep your home spotless with our comprehensive cleaning services. From dusting and vacuuming to deep cleaning kitchens and bathrooms, we ensure every corner is sparkling clean.</p>
                                                
                                            </div>
                                        </div>
                                        <div class="col-sm-6 services-box-img xs-h-300px">
                                            <div class="h-100 cover-background"
                                                style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-services-01.png') }}')"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-0 services-box-style-02">
                                        <div
                                            ...
                                            <div class="services-box-content">
                                                <a href="#services"
                                                    class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Commercial Cleaning</a>
                                                <p class="mb-15px">Maintain a professional and hygienic workspace with our tailored commercial cleaning solutions. We provide daily, weekly, or monthly services that meet the specific needs of your business.</p>
                                               
                                            </div>
                                        </div>
                                        <div class="col-sm-6 services-box-img xs-h-300px">
                                            <div class="h-100 cover-background"
                                                style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-services-04.png') }}')"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row g-0 services-box-style-02">
                                        <div
                                            ...
                                            <div class="services-box-content">
                                                <a href="#services"
                                                    class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Carpet cleaning</a>
                                                <p class="mb-15px">Restore the look and feel of your carpets and furniture. Our deep cleaning techniques remove stains, dirt, and allergens, leaving your fabrics fresh and clean.</p>
                                                
                                            </div>
                                        </div>
                                        <div class="col-sm-6 services-box-img xs-h-300px">
                                            <div class="h-100 cover-background"
                                                style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-services-02.png') }}')"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row g-0 services-box-style-02">
                                        <div
                                            ...
                                            <div class="services-box-content">
                                                <a href="#services"
                                                    class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Window Cleaning</a>
                                                <p class="mb-15px">Let the light shine through with our streak-free window cleaning service. We clean windows inside and out, ensuring a crystal-clear view.
                                                </p>
                                        ...
                                        <div class="col-sm-6 services-box-img xs-h-300px">
                                            <div class="h-100 cover-background"
                                                style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-services-03.png') }}')"></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="cover-background mb-5" style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-testimonial.png') }}')">
                    ...
                    <div class="swiper position-relative"
                        ...
                        <div class="swiper-wrapper mb-40px">
                            ...
                            <div class="swiper-slide review-style-08">
                                <p class="text-white opacity-7 w-80 lg-w-100">The team exceeded my expectations! They were punctual, professional, and left my home spotless. I’ve used other cleaning services before, but none compare to the attention to detail and care these guys showed. Highly recommend them for anyone looking for a reliable and thorough cleaning service!</p>
                                <div class="mt-20px">
                                    <img class="w-110px me-15px" src={{ asset('assets/cleaning/images/demo-cleaning-testimonials-01.png') }}
                                        alt="">
                            ...
                            <!-- start text slider item -->
                            <div class="swiper-slide review-style-08">
                                <p class="text-white opacity-7 w-80 lg-w-100">I hired them for a deep clean after a renovation, and they did an amazing job. Every room was immaculate, and they even tackled areas I hadn’t thought of. Their eco-friendly products were a bonus, making me feel great about the service. I’ll definitely be using them again!</p>
                                <div class="mt-20px">
                                    <img class="w-110px me-15px" src={{ asset('assets/cleaning/images/demo-cleaning-testimonials-02.png') }}
                                        alt="">
                                    <div class="d-inline-block align-middle text-start">
                            ...
                            <!-- start text slider item -->
                            <div class="swiper-slide review-style-08">
                                <p class="text-white opacity-7 w-80 lg-w-100">I run a small business and keeping the office clean is a must. This team has been handling our commercial cleaning for months, and the place has never looked better. They’re consistent, dependable, and always leave the office in perfect condition. Fantastic service!</p>
                                <div class="mt-20px">
                                    <img class="w-110px me-15px" src={{ asset('assets/cleaning/images/demo-cleaning-testimonials-03.png') }}
                                        alt="">
                                    <div class="d-inline-block align-middle text-start">
            ...
            <div
                ...
                <div class="col-lg-4 md-h-700px sm-h-500px">
                    <div class="cover-background background-position-center-top h-100"
                        style="background-image: url('{{ asset('assets/cleaning/images/demo-cleaning-contact.png') }}');">
                    </div>
                </div>
            </div>
        </div>
